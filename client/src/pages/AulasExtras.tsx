      ...
      <div className="space-y-3 max-h-96 overflow-y-auto">
        {(comentarios as any[]).map((c: any) => (
          <div key={c.id} className="bg-muted/40 rounded-xl p-3 space-y-2">
              ...
              <div className="flex gap-1 flex-shrink-0">
                {!c.resposta && respondendo !== c.id && (
                  <Button size="sm" variant="outline"
                    ...
                    className="h-6 px-2 text-[10px] border-emerald-400/60 text-emerald-700 hover:bg-emerald-50">
                    Responder
                  </Button>
                )}
            ...
            {/* Resposta existente */}
            {c.resposta && (
              <div className="ml-3 pl-3 border-l-2 border-emerald-400/40 space-y-0.5">
                <p className="text-[10px] font-semibold text-emerald-700 uppercase tracking-wide">Catequista respondeu</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="text-[10px] text-muted-foreground hover:text-emerald-700 underline">
                    Editar
                  </button>
                </div>
              </div>
            ...
            {respondendo === c.id && (
              <div className="ml-3 space-y-1.5">
                <textarea
                  ...
                  rows={2}
                  className="w-full text-xs border border-emerald-300 rounded-lg px-3 py-2 bg-background focus:outline-none focus:ring-2 focus:ring-emerald-300/50 resize-none"
                  autoFocus
                />
